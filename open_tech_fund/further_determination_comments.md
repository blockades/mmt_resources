...
We will continue look for funding from other sources.  These include the Prototype fund and the 'mission partners' Mozilla Open Source Support award, and some European Union grants.  We are also considering a number of foundations and companies in the blockchain sector, as they have a need for such mechanisms and are investing in research and development of impactful utilities. However we would not accept funding unconditionally and have no interest in grants which would require us to significantly change our project's goals or work on proprietary software. In the meantime we will continue to maintain what we have already built.
